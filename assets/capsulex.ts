...
export type Capsulex = {
  ...
  instructions: [
    {
      name: 'completeGame';
      discriminator: [105, 69, 184, 5, 143, 182, 92, 132];
      accounts: [
        {
          name: 'authority';
          writable: true;
    ...
    {
      name: 'createCapsule';
      discriminator: [195, 104, 42, 180, 127, 169, 62, 3];
      accounts: [
        {
          name: 'creator';
          writable: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: 'const';
                value: [99, 97, 112, 115, 117, 108, 101];
              },
              {
                kind: 'account';
                path: 'creator';
    ...
    {
      name: 'mintCapsuleNft';
      discriminator: [157, 233, 60, 113, 103, 186, 247, 209];
      accounts: [
        {
          name: 'creator';
          writable: true;
    ...
    {
      name: 'mintTrophyNft';
      discriminator: [53, 65, 131, 97, 82, 246, 31, 167];
      accounts: [
        {
          name: 'authority';
          writable: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: 'const';
                value: [116, 114, 111, 112, 104, 121, 95, 109, 105, 110, 116];
              },
              {
                kind: 'account';
                path: 'user';
    ...
    },
    {
      ...
      discriminator: [181, 60, 45, 164, 157, 254, 89, 89];
      accounts: [
        {
          name: 'authority';
          writable: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: 'const';
                value: [98, 97, 100, 103, 101, 95, 109, 105, 110, 116];
              },
              {
                kind: 'account';
                path: 'game';
    ...
    {
      name: 'revealCapsule';
      discriminator: [217, 13, 28, 128, 0, 255, 1, 167];
      accounts: [
        {
          name: 'creator';
          writable: true;
    ...
    {
      name: 'verifyGuess';
      discriminator: [45, 170, 104, 146, 146, 102, 230, 104];
      accounts: [
        {
          name: 'authority';
          writable: true;
  ...
  accounts: [
    {
      name: 'capsule';
      discriminator: [212, 231, 77, 219, 58, 13, 118, 241];
    },
    {
      name: 'game';
    ...
    {
      name: 'guess';
      discriminator: [199, 136, 162, 22, 201, 176, 249, 195];
    },
    {
    ...
    {
      name: 'programVault';
      discriminator: [19, 247, 127, 147, 186, 67, 82, 61];
    },
  ];
  events: [
    {
      name: 'capsuleCreated';
      discriminator: [113, 132, 247, 198, 217, 47, 201, 223];
    },
    {
      name: 'capsuleNftMinted';
      discriminator: [39, 86, 188, 158, 25, 167, 138, 63];
    },
    {
      name: 'capsuleRevealed';
      discriminator: [38, 218, 116, 91, 16, 17, 230, 195];
    },
    {
      name: 'gameCompleted';
      discriminator: [103, 26, 106, 108, 240, 191, 179, 120];
    },
    {
    ...
    {
      name: 'guessSubmitted';
      discriminator: [9, 204, 248, 63, 138, 8, 159, 123];
    },
    {
      name: 'leaderboardInitialized';
      discriminator: [135, 70, 99, 96, 246, 187, 226, 226];
    },
    {
      name: 'leaderboardUpdated';
      discriminator: [28, 209, 133, 1, 229, 195, 230, 228];
    },
    {
      name: 'pointsAwarded';
      discriminator: [201, 95, 152, 50, 215, 83, 188, 38];
    },
    {
    ...
    },
    {
      ...
      discriminator: [90, 139, 171, 205, 108, 106, 108, 88];
    },
    {
      name: 'winnerBadgeMinted';
      discriminator: [145, 113, 233, 144, 51, 59, 168, 32];
    },
    {
      name: 'winnerFound';
      discriminator: [21, 176, 140, 230, 243, 252, 250, 172];
    },
  ];
  errors: [
    {
